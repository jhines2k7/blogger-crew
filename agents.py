...
class BloggerCrewAgents():
    def content_strategist(self):
        return Agent(
            ...
            backstory=f"""With a deep understanding of the target audience and a keen sense of what resonates, you
    ...
    def researcher(self):
        return Agent(
            ...
            backstory=f"""As a skilled researcher, you dive deep into the subject matter, gathering facts, statistics, and
    ...
    def writer(self):
        return Agent(
            ...
            backstory=f"""As a skilled wordsmith, you craft compelling narratives that captivate readers, ensuring
    ...
    def editor(self):
        return Agent(
            ...
            backstory=f"""With a sharp eye for detail and a commitment to quality, you refine the content, ensuring
    ...
    def seo_specialist(self):
        return Agent(
            ...
            backstory=f"""As an SEO expert, you leverage your knowledge of search engine algorithms to improve the
    ...
    def photographer(self):
        return Agent(
            ...
            backstory=f"""As a photographer, you capture or create unique images that enrich the content, giving it
                ...
                Remember, the more descriptive and specific the prompt is, the better the AI can understand and generate the desired image. Including details about the subject, 
                setting, lighting, textures, and style can help achieve what we're looking for..
            """,
            verbose=True,
            allow_delegation=True,
    ...
    def social_media_manager(self):
        return Agent(
            ...
            backstory=f"""As a social media savant, you develop strategies to share the post across various platforms,
    ...
    def web_developer(self):
        return Agent(
            ...
            backstory=f"""With expertise in web technologies, you ensure the blog post is properly formatted and
